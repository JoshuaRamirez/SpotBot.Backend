...
namespace SpotBot.Server.Exchange.RestApi.Services
{
    public partial class GetKLinesRequest
    {
        ...
        public GetKLinesRequest(Connection connection)
        {
            _connection = connection ?? throw new ArgumentNullException(nameof(connection));
        }

        // Retrieves symbols for a specific user and optional market
        public GetKLinesResponse Execute(int userId, string symbol, TimeInterval timeInterval, DateTime? startAt = null, DateTime? endAt = null)
        {
